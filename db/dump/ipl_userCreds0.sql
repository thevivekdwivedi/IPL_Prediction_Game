...
INSERT INTO `userCreds` VALUES ('thevivekdwivedi',' ši3gÝ›ùk¢bÔpw','¡¶÷…àJ·9Í}îWè1ý3]!o˜ƒh‘=ÊÁ');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `ipl`.`userCreds_BEFORE_INSERT` BEFORE INSERT ON `userCreds` FOR EACH ROW
BEGIN
set NEW.password=AES_ENCRYPT(NEW.password, 'do your worst');
set NEW.apiKey=AES_ENCRYPT(NEW.apiKey, 'fuck you too');
END */;;
DELIMITER ;
...
-- Dump completed on 2018-04-20  7:33:05
