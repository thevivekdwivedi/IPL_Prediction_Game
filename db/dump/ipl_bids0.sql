...
CREATE TABLE `bids` (
  ...
  CONSTRAINT `bid_matchID_fk` FOREIGN KEY (`matchID`) REFERENCES `roster` (`matchID`) ON UPDATE NO ACTION,
  CONSTRAINT `bid_userID_fk` FOREIGN KEY (`userID`) REFERENCES `users` (`userID`) ON DELETE NO ACTION ON UPDATE NO ACTION
